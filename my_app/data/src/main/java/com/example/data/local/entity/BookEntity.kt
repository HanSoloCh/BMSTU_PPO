...
//    val originalLanguage = varchar("original_language", 100).nullable()
    ...
    val originalLanguageId =
        reference("original_language_id", LanguageEntity, onDelete = ReferenceOption.RESTRICT).nullable()
    val secondaryLanguageId =
        reference("secondary_language_id", LanguageEntity, onDelete = ReferenceOption.RESTRICT).nullable()
